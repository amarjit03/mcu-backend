...
async def seed_db() -> None:
    """
    Asynchronously seeds the database with baseline test entities.
    Checks if records exist first to avoid duplicate inserts.
    """
    async with async_session_maker() as db:
        try:
            # Verify if database has already been seeded
